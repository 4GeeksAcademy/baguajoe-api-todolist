...
import { fetchTasks, addTasksToApi, deleteTaskFromApi, createUser, deleteUser } from "../todoApi";
    ...
    return (
        <div className="container pb-5 px-4 rounded">
            ...
            <div className="buttonGroup mt-4 gap-2 d-flex justify-content-center">
                ...
                <button className="btn btn-light" type="button" onClick={handleDeleteUser}>Delete User & All Tasks</button>
            </div>
        </div>
    );
};
